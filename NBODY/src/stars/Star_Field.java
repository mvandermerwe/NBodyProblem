...
public class Star_Field extends JPanel
	 ...
	 * FIXME:
	 *
	 * if the mouse is clicked on top of a star it should go super nova. you
	 * should look at the component getRectangle method and the contains method.
	 *
	 ...
	 * 
	 * if the mouse is clicked on top of a planet it and you have extra time,
	 * you should make the planet explode (remove the planet from the simulation
	 * and add a bunch of flotsum)!
	 *
	 * @param e
	 *            - the mouse event
	 */
